...
export default function JoinScreen() {
  ...
  async function endCall() {
    ...
    // await deleteDoc(calleeCandidatesCollection);
    const calleeCandidatesSnapshot = await getDocs(calleeCandidatesCollection);
    calleeCandidatesSnapshot.forEach((doc) => {
      deleteDoc(doc.ref);
    });
  ...
  const joinCall = async (id) => {
    ...
    try {
      ...
      Alert.alert("Eroor", e.message);
    }

    const unsub1 = onSnapshot(callerCandidatesCollection, (snapshot) => {
